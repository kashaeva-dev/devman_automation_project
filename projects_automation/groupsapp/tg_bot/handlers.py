from groupsapp.models import Week
...
def slots_keyboard_handler(update: Update, context: CallbackContext):
    ...
    if data == 'any_time':
        ...
        for interval in intervals:
            interval_slots = list(
                bot_methods.get_slots_from_interval(interval))
        ...
        context.bot.send_message(
            ...
            text=f'Неделя: {week}\n'
                 f'Студент: {student}\n'
                 'Составы команд, бриф и все остальное '
                 'пришлю в следующий понедельник.\n\n'
    ...
    if data == 'done':
        ...
        context.bot.send_message(
            chat_id=chat_id,
            text='Составы команд, бриф и все остальное пришлю '
